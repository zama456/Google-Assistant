...
import com.zama.googleassistant.MainActivity
import com.zama.googleassistant.R
import com.zama.googleassistant.utils.utils
import com.zama.googleassistant.utils.utils.Commands
...
class ExploreActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ContextCompat.checkSelfPermission(this@ExploreActivity,android.Manifest.permission.ACCESS_FINE_LOCATION
            ) !==
