...
import static com.theartofdev.edmodo.cropper.CropImageView.Guidelines.ON;
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!nm.isEmpty()) {
                    ...
                    Toast.makeText(GoogleLensActivity.this, "Add Image With Text", Toast.LENGTH_SHORT).show();
                }
            }
        });
